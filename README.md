...
2. Crie uma branch com o padrão: `mobile-challenge/seu-nome-sobrenome`;
...
6. Envie um email para `vagas@datasmart.com.br` com o título: `Desenvolvedor Mobile - Seu Nome Sobrenome`. Adicione seu telefone, LinkedIn, seu perfil do GitHub e em anexo seu currículo.
